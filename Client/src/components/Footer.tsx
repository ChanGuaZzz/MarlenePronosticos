        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <button 
              ...
              className="flex items-center text-sm text-green-300 hover:text-white transition-colors"
            >
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/" className="text-green-300 hover:text-white transition-colors">Inicio</Link></li>
              <li><Link to="/about" className="text-green-300 hover:text-white transition-colors">Sobre nosotros</Link></li>
              <li><Link to="/pronosticos" className="text-green-300 hover:text-white transition-colors">Pronósticos</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/analisis" className="text-green-300 hover:text-white transition-colors">Análisis Deportivo</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="flex items-center">
                ...
                <span className="text-green-300">+1 234 567 890</span>
              </li>
